...
SECRET_KEY = 'django-insecure-(=#din753co=@@=zj=@sb81exr3!=w1pvm$cv%olb)*2ms2jb8'
...
INSTALLED_APPS = [
    ...
    'django.contrib.staticfiles',
     # Local apps
    'core_app.apps.CoreAppConfig', # Added the core app
]
...
LOGIN_REDIRECT_URL = 'specialist_search' # Redirect after login to dashboard
